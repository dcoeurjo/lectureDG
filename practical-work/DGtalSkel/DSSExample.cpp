...
int main()
{
  ...
  ArithmeticalDSS< Iterator, Integer, 8> a8DSS;
  ...
  board << SetMode(Point().className(), "Grid")
	<< SetMode(a8DSS.className(), "Points")
	<< a8DSS ;
  //..and the DSS bounding box
  board << SetMode(Point().className(), "Grid")
	<< SetMode(a8DSS.className(), "BoundingBox")
	<< a8DSS ;
